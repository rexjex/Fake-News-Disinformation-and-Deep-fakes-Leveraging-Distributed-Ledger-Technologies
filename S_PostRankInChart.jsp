...
<head>
<title>News Post Rank Chart Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#FF0033">News Post Rank In Chart..</h2>
          <div class="clr"></div>
		  <div class="post_content">


            <p>&nbsp;</p>
            <iframe width="500" height="350" src="S_NewsPostRankInChart.jsp"></iframe>
			<div align="center"><br/>
			    <span class="style3 style14">(All News Post)</span>		    </div>
			  				<p>&nbsp;</p>
