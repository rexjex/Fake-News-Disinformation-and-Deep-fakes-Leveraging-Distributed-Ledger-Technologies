...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style3" style="color:#FF0033">User <span class="style9"><%=request.getParameter("uname")%></span>'s Details</h2>
          <div class="clr"></div>
          ...
          <p align="right">&nbsp;</p>
          <p align="center"><a href="U_Review.jsp?nname=<%=nname%>&chname=<%=chname%>&id=<%=id%>&user=<%=user%>" class="style11">Back</a></p>
