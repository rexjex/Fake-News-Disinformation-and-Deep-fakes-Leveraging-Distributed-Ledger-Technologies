...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#FF0033">User <span class="style2" style="color:#006666"><%=(String)application.getAttribute("user")%></span>'s Search Transactions ..</h2>
          <div class="clr"></div>
		  <div class="post_content">
	        ...
	        <table width="623" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
              <tr>
                ...
                <td  width="118" valign="baseline" height="34" style="color: #2c83b0;"><div align="center" class="style15 style21 style5 style6 style12 style13">Hash Code</div></td>
              ...
              <%
						...
						try 
						{
						    String user = (String)application.getAttribute("user");
						   	String query="select * from searchtransaction where user='"+user+"'"; 
              ...
              <tr>
                ...
                <td  valign="baseline" height="0"><p class="style22 style5 style4 style6">&nbsp;</p>
                   <div align="center" class="style22 style6">
                     <span class="style11">
                     <%out.println(s3);%>
                     </span>
                     <p>&nbsp; </p>
              ...
              <%
                ...
                <p align="left" class="style7"><a href="User_Main.jsp">Back</a></p>
