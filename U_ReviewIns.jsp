...
<head>
<title>User Review Insert Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#FF0033">User Review Status On News Post <span class="style2" style="color:#006666"><%=request.getParameter("nname")%> ..</h2>
          <div class="clr"></div>
...
PreparedStatement pst=connection.prepareStatement("insert into reviews(n_name,nc_name,rname,reviews,dt) values(?,?,?,?,?)");
             
			pst.setString(1,nname);
            pst.setString(2,chname);
...
<span class="style4"> Reviewed Successfully...</span>
  <p align="right"><a href="User_Main.jsp" class="style47">Back</a></p>
                  <%
