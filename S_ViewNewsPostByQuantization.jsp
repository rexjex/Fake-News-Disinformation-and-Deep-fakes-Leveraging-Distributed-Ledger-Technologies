...
<head>
<title>News Post Bydistributed ledger technologies</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#FF0033">View All News Post By distributed ledger technologies ..</h2>
          <div class="clr"></div>
	...
	{		   
			...
			<p class="style5 style8 style15">	Current Trending News....  </p>
	  	    <table width="650" border="0">
					  ...
					  <td width="205" bgcolor="#FFFF00"><div align="center" class="style17"><span class="style3 "><b>News Date</b></span></div></td>
    				  <td width="178" bgcolor="#FFFF00"><div align="center" class="style17"><b>Channel Name</b></div></td>
				   	  <td width="178" bgcolor="#FFFF00"><div align="center" class="style17"><b>News Name</b></div></td>
  					 
      				  <td width="293" bgcolor="#FFFF00"><div align="center" class="style17"><span class="style3 "><b>Description</b> </span></div></td>
   					  <td width="178" bgcolor="#FFFF00"><div align="center" class="style17"><b>News Image</b></div></td>
	  				  
	  				  <td width="205" bgcolor="#FFFF00"><div align="center" class="style17"><span class="style3 "><b>News Place</b></span></div></td>
	  				  
                   </tr>
				 
				  <%
					  
						   String query="select * from news where quant_date>='"+strCurrDate+"' and nc_name='"+server+"' order by n_date desc "; 
	...
	<p>&nbsp;</p>
		        ...
		        <table width="650" border="0">
				  ...
				  <%
						   ...
						   String query1="select * from news where quant_date<'"+strCurrDate+"' and nc_name='"+server+"' order by n_date desc "; 
