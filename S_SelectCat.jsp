...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style2" style="color:#FF0033">Result Details..</h2>
          <div class="clr"></div>
		  <div class="post_content">
           ...
           <form name="s" action="S_ViewProductQuantInChart.jsp" method="post"  onSubmit="return valid()"  ons target="_top">	
	  <%
...
%>
             <table width="850" border="0" align="center"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse; display:inline; margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
					...
					<tr>
 						<td   width="270" align="left" valign="middle" height="45" style="color: #2c83b0;"><div align="left" class="style5" style="margin-left:20px;">Select Category </div></td>
					...
					<div > <tr><td height="45" colspan="2" id="learn_more" align="center"  style="color:#003399;"><input type="submit" value="Show in Chart" style="width:100px; height:35px; background-color:#999999; color:#003399;"/>
